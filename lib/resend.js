...
export async function sendContactNotification({ fullName, email, phone, subject, message }) {
  try {
    ...
    // Make sure BUSINESS_EMAIL is set to your verified email: contact@alkocars.com
    const businessEmail = process.env.BUSINESS_EMAIL || 'contact@alkocars.com';
    ...
    if (error) {
      ...
      console.log('💡 Make sure BUSINESS_EMAIL in .env.local is: contact@alkocars.com');
