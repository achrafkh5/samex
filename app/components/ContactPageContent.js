...
export default function ContactPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-32 pb-12 sm:pb-16 bg-gradient-to-br from-blue-600 to-purple-600 dark:from-gray-900 dark:via-blue-900 dark:to-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {/* Breadcrumb */}
          <nav className="flex items-center mb-4 sm:mb-6 text-xs sm:text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-200 dark:border-gray-800">
                ...
                <div className="space-y-3 sm:space-y-4">
                  {contactInfo.map((info, index) => (
                    <div
                      key={index}
                      className={`p-3 sm:p-4 rounded-xl bg-gradient-to-br from-${info.color}-50 to-${info.color}-100 dark:from-${info.color}-900/20 dark:to-${info.color}-900/10 border border-${info.color}-200 dark:border-${info.color}-800 hover:shadow-lg transition-all`}
                    >
                      <div className="flex items-start space-x-3 sm:space-x-4">
                        <div className={`flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-${info.color}-600 dark:bg-${info.color}-500 rounded-xl flex items-center justify-center text-white`}>
                          {info.icon}
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          <a
                            ...
                            className="text-gray-600 dark:text-gray-300 text-xs sm:text-sm hover:text-blue-600 transition-colors block break-words"
                          >
                            {info.value}
                          </a>
                          {info.extraPhones && info.extraPhones.map((phone, idx) => (
                            <a
                              ...
                              className="text-gray-600 dark:text-gray-300 text-xs sm:text-sm hover:text-blue-600 transition-colors block mt-1"
                            >
                              {phone}
                            </a>
                          ))}
                ...
                <div className="flex items-center space-x-3">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 dark:bg-gray-800 hover:bg-gradient-to-br hover:from-blue-600 hover:to-purple-600 text-gray-600 dark:text-gray-400 hover:text-white rounded-xl flex items-center justify-center transition-all hover:scale-110"
            ...
            <div className="lg:col-span-2 space-y-6 sm:space-y-8">
              {/* Contact Form */}
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-gray-200 dark:border-gray-800">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-200 dark:border-gray-800">
                ...
                <div className="rounded-xl overflow-hidden h-64 sm:h-80 lg:h-96 border border-gray-200 dark:border-gray-800">
                  <iframe
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-4 inline-flex items-center space-x-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors text-sm sm:text-base"
                >
                  <span>{t('visitUs')}</span>
