...
export default function ContactPageContent() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: t('email'),
      value: 'info@dreamcars.com',
      link: 'mailto:info@dreamcars.com',
      color: 'purple'
    },
    {
      icon: (
      ...
      title: t('address'),
      value: '123 Luxury Avenue, Dream City, DC 12345',
      link: 'https://maps.google.com/?q=123+Luxury+Avenue+Dream+City',
      color: 'green'
    }
  ];

  const workingHours = [
    { day: t('mondayFriday'), hours: '9:00 AM - 8:00 PM' },
    { day: t('saturday'), hours: '10:00 AM - 6:00 PM' },
                ...
                <div className="space-y-4">
                  {contactInfo.map((info, index) => (
                    <a
                      ...
                      className={`flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-br from-${info.color}-50 to-${info.color}-100 dark:from-${info.color}-900/20 dark:to-${info.color}-900/10 border border-${info.color}-200 dark:border-${info.color}-800 hover:shadow-lg transition-all group`}
                    >
                      <div className={`flex-shrink-0 w-14 h-14 bg-${info.color}-600 dark:bg-${info.color}-500 rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform`}>
                        {info.icon}
                      </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-800">
                ...
                <div className="rounded-xl overflow-hidden h-96 border border-gray-200 dark:border-gray-800">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9476519598093!2d-73.99185268459395!3d40.74117427932881!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259a9b3117469%3A0xd134e199a405a163!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen=""
                    ...
                    title="DreamCars Location"
                  ></iframe>
                </div>
                <a
                  href="https://maps.google.com/?q=123+Luxury+Avenue+Dream+City"
                  target="_blank"
                  rel="noopener noreferrer"
