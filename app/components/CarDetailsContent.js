                    ...
                    <div>
                      {car.specs?.features && car.specs.features.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 font-medium">{t('noFeaturesAdded')}</p>
                          <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">{t('startAddingFeatures')}</p>
                        </div>
                      )}
                    </div>
                  )}
