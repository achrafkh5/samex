...
export default function AdminSidebar({ currentPage, onNavigate }) {
  ...
  const menuItems = [
    ...
    {
      id: 'payment-methods',
      name: t('paymentMethods') || 'Payment Methods',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      id: 'transitaires',
      name: t('transitairesManagement') || 'Customs Brokers',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
          ...
          {mounted && (
            ...
            >
              ...
              <span className="font-medium">{theme === 'dark' ? (t('lightMode') || 'Light Mode') : (t('darkMode') || 'Dark Mode')}</span>
            </button>
          )}
